...
function loadable(anAtom) {
  return memo1(function () {
    ...
    var refreshAtom = vanilla.atom([function () {}, 0]);
    refreshAtom.unstable_onInit = function (store) {
      store.set(refreshAtom, function (_ref) {
        var c = _ref[1];
        return [function () {
          return store.set(refreshAtom, function (_ref2) {
            var f = _ref2[0],
              c = _ref2[1];
            return [f, c + 1];
          });
    ...
    var derivedAtom = vanilla.atom(function (get) {
      var _get = get(refreshAtom),
        triggerRefresh = _get[0];
      var value;
      try {
        value = get(anAtom);
      } catch (error) {
