...
export const TopMenu: FC = () => {
	...
	const onOpenLyrprep = useCallback(async () => {
		if (import.meta.env.TAURI_ENV_PLATFORM) {
			await open("https://lyrprep.spicylyrics.org/");
		} else {
			window.open("https://lyrprep.spicylyrics.org/");
		}
	}, []);
				...
				<Toolbar.Root>
					...
					<DropdownMenu.Root>
						...
						<DropdownMenu.Content>
							...
							<DropdownMenu.Item disabled onSelect={onOpenLatencyTest}>
					...
					<DropdownMenu.Root>
						...
						<DropdownMenu.Content>
							<DropdownMenu.Item onSelect={onOpenLyrprep}>
								Lyrprep
							</DropdownMenu.Item>
							{/*<DropdownMenu.Item onSelect={onOpenWiki}>
								{t("topBar.menu.helpDoc", "使用说明")}
